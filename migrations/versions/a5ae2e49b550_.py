...
Revision ID: a5ae2e49b550
Revises: c18aab884525
Create Date: 2024-10-14 00:33:35.857780
...
revision: str = 'a5ae2e49b550'
down_revision: Union[str, None] = 'c18aab884525'
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.String(length=255), nullable=False, comment='동의 고유번호'),
    ...
    op.alter_column('notes', 'user_id',
               ...
               comment='사용자 고유 아이디',
               existing_nullable=False)
    op.alter_column('settings', 'user_id2',
               existing_type=mysql.INTEGER(),
               type_=sa.BigInteger(),
               comment='사용자 고유 아이디',
               existing_nullable=False)

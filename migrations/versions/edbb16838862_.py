...
Revision ID: edbb16838862
Revises: 47551d3699f4
Create Date: 2024-11-30 13:42:56.744749
...
revision: str = 'edbb16838862'
down_revision: Union[str, None] = '47551d3699f4'
...
def upgrade() -> None:
    ...
    op.drop_constraint('fk_member_group_invite_id', 'member', type_='foreignkey')

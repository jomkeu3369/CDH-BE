...
Revision ID: 5c851047c51e
Revises: 5cdbed9ea830
Create Date: 2024-10-14 11:38:43.780371
...
revision: str = '5c851047c51e'
down_revision: Union[str, None] = '5cdbed9ea830'
...
def upgrade() -> None:
    ...
    op.alter_column('notes', 'user_id',
               ...
               comment='사용자 고유 아이디',
               existing_nullable=False)
    op.add_column('settings', sa.Column('pk', sa.Integer(), autoincrement=True, nullable=False))
